...
quad_thrusters = {"front": Thruster(( r,  0, 0.02), thrust_from_effort, effort_from_thrust, reaction_coeff, max_rpm),
...
hex_thrusters = {"fl": Thruster(npl.matrix_power(R, 1).dot([r, 0, 0.02]), thrust_from_effort, effort_from_thrust, reaction_coeff, max_rpm),
